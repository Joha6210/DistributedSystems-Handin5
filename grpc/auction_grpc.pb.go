...
type AuctionClient interface {
	...
	Result(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AuctionResult, error)
}
...
func (c *auctionClient) Result(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AuctionResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuctionServer interface {
	...
	Result(context.Context, *emptypb.Empty) (*AuctionResult, error)
...
func (UnimplementedAuctionServer) Result(context.Context, *emptypb.Empty) (*AuctionResult, error) {
